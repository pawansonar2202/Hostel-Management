			...
			<form action="" id="manage-house">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"style="background-color:black;border-color:black"> Save</button>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_house" type="button" data-id="<?php echo $row['id'] ?>"  data-house_no="<?php echo $row['house_no'] ?>" data-description="<?php echo $row['description'] ?>" data-category_id="<?php echo $row['category_id'] ?>" data-price="<?php echo $row['price'] ?> " style="background-color:grey;border-color:grey">Edit</button>
...
<script>
	$('.edit_house').click(function(){
		uni_modal("Manage Tenant Details","manage_house.php?id="+$(this).attr('data-id'),"mid-large")

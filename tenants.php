			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Tenant</b>
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_tenant"style="background-color:black;border-color:black">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm view_payment" type="button" data-id="<?php echo $row['id'] ?>" style="background-color:black;border-color:black;color:white">View</button>
										<button class="btn btn-sm btn-outline-primary edit_tenant" type="button" data-id="<?php echo $row['id'] ?>" style="background-color:grey;border-color:grey;color:white">Edit</button>
										<button class="btn btn-sm btn-outline-danger delete_tenant" type="button" data-id="<?php echo $row['id'] ?>" style="background-color:red;border-color:red;color:white">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>

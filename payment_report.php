				...
				<div class="col-md-12">
					<form id="filter-report">
						<div class="row form-group">
							...
							<button class="btn btn-sm btn-block btn-primary col-md-2 ml-1" style="background-color: black !important">Filter</button>
						</div>
					</form>
					<hr>
						<div class="row">
...
<script>
	...
	$('#filter-report').submit(function(e){
		e.preventDefault()
		location.href = 'index2.php?page=payment_report&'+$(this).serialize()
	})
</script>